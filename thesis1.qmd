...
# CO~2~ Captured using Molten Salt Carbonate Electrolysis
...
<span style="background-color: #1f3c73; color: white; padding: 0.5rem 1rem; border-radius: 0.5rem;">AutoCAD 3D</span>

<span style="background-color: #1f3c73; color: white; padding: 0.5rem 1rem; border-radius: 0.5rem;">CO2 Captured using Molten Salt</span>
...
<span style="background-color: #1f3c73; color: white; padding: 0.5rem 1rem; border-radius: 0.5rem;">Experimental Design</span>
