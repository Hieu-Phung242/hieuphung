...
[ArcGIS Pro]{style="background-color: #1f3c73; color: white; padding: 0.5rem 1rem; border-radius: 0.5rem;"}

[Linear Regression Analysis]{style="background-color: #1f3c73; color: white; padding: 0.5rem 1rem; border-radius: 0.5rem;"}

[Create Map]{style="background-color: #1f3c73; color: white; padding: 0.5rem 1rem; border-radius: 0.5rem;"}

[Calculating Vegetation Indices]{style="background-color: #1f3c73; color: white; padding: 0.5rem 1rem; border-radius: 0.5rem;"}

[Handling Trajectory GEDI Dataset]{style="background-color: #1f3c73; color: white; padding: 0.5rem 1rem; border-radius: 0.5rem;"}

[Scientific Writing]{style="background-color: #1f3c73; color: white; padding: 0.5rem 1rem; border-radius: 0.5rem;"}

[Research]{style="background-color: #1f3c73; color: white; padding: 0.5rem 1rem; border-radius: 0.5rem;"}
:::
...
The main approach for developing AGB estimation model in this project is as follow: - Generated a rescaled 30-m PlanetScope imagery
