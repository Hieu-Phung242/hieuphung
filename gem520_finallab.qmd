...
<div style="max-width: 600px; margin-bottom: 2em;">
  <div style="position: relative; overflow: hidden; width: 100%;">
    <div style="position: absolute; width: 100%;">
      <img src="images/image_after.png" style="width: 100%;">
    </div>
    <div id="sliderContainer" style="position: relative; width: 100%;">
      <div id="divider" style="position: absolute; top: 0; left: 50%; width: 3px; background: #fff; height: 100%; z-index: 10;"></div>
      <img src="images/image_before.png" id="beforeImage" style="width: 100%; clip-path: inset(0 50% 0 0); position: relative; z-index: 5;">
    </div>
  </div>
</div>
