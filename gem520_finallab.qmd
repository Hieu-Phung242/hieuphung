...
<span style="background-color: #1f3c73; color: white; padding: 0.5rem 1rem; border-radius: 0.5rem;">Time Series Analysis</span>
...
This RGB image show the condition of Prouton Lake before the fire (Left: July, 2015) and after the fire (Right: July, 2018). On the right image, there are areas with white and brown color, indicating the loss of vegetation. This is more obvious when looking at the false color image
